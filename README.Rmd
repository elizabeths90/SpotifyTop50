...
Once you have accessed your id and secret, use the remainder of the code, to gain the information. Once the user has gathered their top 50 songs,you will be using the equisser to determine exactly what factors to show on your plot.The code esquisser provides you will be typed into line 23 of the code between [].
